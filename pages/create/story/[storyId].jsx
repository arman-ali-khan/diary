          ...
          return (
            ...
            >
              ...
              <div className="flex left-0 absolute bottom-0 justify-between w-full">
                <Link href='/create/story/12/12' className="bg-blue-100 flex justify-center text-blue-600 w-full py-1 rounded-l-full hover:bg-blue-200">
                  Edit
                </Link>
